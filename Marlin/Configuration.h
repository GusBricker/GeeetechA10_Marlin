 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.6, 79.6, 400, 423 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, 0, -0.88 }
...
#define INVERT_X_DIR false // Inverted for TMC2209
#define INVERT_Y_DIR false // Inverted for TMC2209
#define INVERT_Z_DIR true // Inverted for TMC2209
...
#define X_BED_SIZE 214 // Reduce X size slightly because the connector on extruder hits frame from 215mm onwards
...
#define Z_MAX_POS 250 // Reduce Z size slightly because the bowden tube gets crushed by top of frame
